...
JArray< jbyte > * de::metux::nebulon::crypt::OpenSSL::AES256_encrypt(JArray< jbyte > * key, JArray< jbyte > * content) {
...
JArray< jbyte > * de::metux::nebulon::crypt::OpenSSL::AES256_decrypt(JArray< jbyte > * key, JArray< jbyte > * content) {
